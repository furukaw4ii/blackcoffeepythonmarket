def notes():
    print("#Hi! My name is Furukawa, I'm the guitarist and one of the founders of BLACK COFFEE, a Brazilian rock band. ")
    print("# This is a simple Python exercise I've made that simulates a shopping experience in our imaginary online store(but soon to be real!).")
    print("# You can add products to your cart, see your cart, remove products, and proceed to payment.")
    print("# We also have some discounts based on the total amount of your shopping list! ")
    print("# We have a Spotify profile, so you can listen to our music! If you like alternative hardcore metal, just search for 'blackcoffee untitled' in Spotify and enjoy our music while you shop!")
    print("# I hope you enjoy it, it took me half a day to build it and a lot of sweat and tears, but it was Fun!!")
